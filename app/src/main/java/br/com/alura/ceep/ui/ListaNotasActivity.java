...
import static br.com.alura.ceep.ui.NotaActivityConstantes.CHAVE_REQUEST_INSERE_NOTA;
import static br.com.alura.ceep.ui.NotaActivityConstantes.CODIGO_REQUISICAO_ALTERA_NOTA;
import static br.com.alura.ceep.ui.NotaActivityConstantes.POSICAO_INVALIDA;

public class ListaNotasActivity extends AppCompatActivity {

    public static final String TITULO_APPBAR = "Notas";
    private ListaNotasRecyclerViewAdapter adapter;
    ...
    private boolean ehCodigoRequisicaoInsereNota(int requestCode) {
        return requestCode == CHAVE_REQUEST_INSERE_NOTA;
    }
    ...
    private void configuraAdapter(List<Nota> todasNotas, RecyclerView listaNotas) {
        adapter = new ListaNotasRecyclerViewAdapter(this, todasNotas);
