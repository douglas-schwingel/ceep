...
public class ListaNotasRecyclerViewAdapter extends RecyclerView.Adapter<ListaNotasRecyclerViewAdapter.NotaViewHolder> {
    ...
    @Override
    public ListaNotasRecyclerViewAdapter.NotaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ListaNotasRecyclerViewAdapter.NotaViewHolder holder, int position) {
